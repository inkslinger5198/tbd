...
export class News extends Component {
  ...
  fetchArticles = async () => {
    ...
    let url = `https://newsapi.org/v2/everything?q=Renewable-Energy-project&energy-storage-maufacturers&ev-charging&smart-grid-technology&sortBy=publishedAt&apiKey=f23e7207679546479d5e5ee13d279c7f&page=${page}&pageSize=${pageSize}&language=en`;
    try {
