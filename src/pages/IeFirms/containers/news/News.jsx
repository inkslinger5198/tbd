...
export class News extends Component {
  ...
  fetchArticles = async () => {
    ...
    let url = `https://newsapi.org/v2/everything?q=infrastructure-firms-in-renewable-energy&sortBy=publishedAt&apiKey=c89e91d831fb46dbb33ffc0b2fb4dfc7&page=${page}&pageSize=${pageSize}&language=en`;
    try {
