...
export class News extends Component {
  ...
  fetchArticles = async () => {
    ...
    let url = `https://newsapi.org/v2/everything?q=renewable-energy-project-developers&sortBy=publishedAt&apiKey=aecc7e44e2cc471a9c0ae22fa88c789b&page=${page}&pageSize=${pageSize}&language=en`;
    try {
