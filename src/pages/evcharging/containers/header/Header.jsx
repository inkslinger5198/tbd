  ...
  return (
    <div className="subheader" id="home">
      <div className="subheader-title">
        <h1>
          We help <span className="blue">EV Charging Companies</span>{" "}Get 7-8 figure <br /> Site-Host Agreements With{" "}
          <TxtRotate
            toRotate={[ "Government", "Developers", "Investors", "Utility Companies" ]}
            period={2000} 
          />
          <br/>in 6 months or Less
        </h1>
