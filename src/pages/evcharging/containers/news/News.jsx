...
export class News extends Component {
  ...
  fetchArticles = async () => {
    ...
    let url = `https://newsapi.org/v2/everything?q=EV-charging&sortBy=publishedAt&apiKey=20d581142dd4436eb6bf6d7dfaf0d130&page=${page}&pageSize=${pageSize}&language=en`;
    try {
