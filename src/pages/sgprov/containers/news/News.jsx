...
export class News extends Component {
  ...
  fetchArticles = async () => {
    ...
    let url = `https://newsapi.org/v2/everything?q=smart-grid-technology-providers||smart-grid-technology&sortBy=publishedAt&apiKey=10ec9ce13bc64f7a95264f18c49fc3b6&page=${page}&pageSize=${pageSize}&language=en`;
    try {
